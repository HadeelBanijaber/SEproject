...
public class contactUs{
	...
	@Given("the user wont to contact the system")
	public void the_user_wont_to_contact_the_system() {
	...
	public void print_all_he_can_use_to_contact_us() {
		...
		System.out.println("CONTACT US");
		 System.out.println("You can contact us dear");
		   ...
		   System.out.printf("\t \t ");
		   System.out.printf("Facebook:Palestinian cleaner");
		   System.out.printf("\t \t ");
		   System.out.printf("Instagram:cleaner.ps");
	}
